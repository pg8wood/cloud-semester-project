...
The value attribute "emailAddressValidator" is set to be the validator-id.
A JSF XHTML page uses this id to execute the "validate" method of this class.
For example, the SendEmail.xhtml page uses <f:validator validatorId="emailAddressValidator" /> 
